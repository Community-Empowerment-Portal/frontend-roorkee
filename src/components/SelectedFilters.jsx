...
function SelectedFilters() {
  ...
  const canUsePreferences = privacySettings.allow_information_usage && 
  ...
  const hasFilters = newSponser.length > 0 || newState.length > 0 || 
                    newDepartment.length > 0 || beneficiaries.length > 0;
