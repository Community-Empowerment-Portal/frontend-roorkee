...
const NavBar = () => {
  ...
  return (
    <div style={{ maxWidth: '80%', margin: '0 auto' }} className="flex justify-between items-center py-[20px] z-10 relative">
      {/* LogoImage */}
      <div className="">
      ...
      <div className="flex gap-4">
            ...
            <div className="">
              <button className="text-white bg-onclick-btnblue px-[24px] py-[7px] rounded-[8px] flex items-center border border-onclick-btnblue text-[14px] font-semibold"
              onClick={handGotoLoginpage}>Login</button>
            </div>
      </div>
    </div>
  );
