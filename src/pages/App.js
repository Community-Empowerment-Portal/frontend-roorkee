  ...
  return (
    <div>
      ...
      <div className="sm:w-full  mx-auto">
        {/* Main Container */}
        <div className=" p-[25px_0] mx-auto">
          {/* First Row */}
          <div className="flex flex-col items-center lg:flex-row justify-center gap-8 p-4">
            ...
            <div className="flex flex-col w-full lg:w-[482px]  items-start gap-[20px] lg:text-left">
              ...
              <div className=" flex flex-row w-full h-auto items-center sm:items-start gap-4 sm:gap-8 p-6 md:p-8 rounded-[16px] justify-center shadow-[0px_4px_10px_rgba(0,0,0,0.1),_0px_-4px_10px_rgba(0,0,0,0.1)]">
                <div className="text-center sm:text-left text-[#000000] font-inter text-[14px] sm:text-[16px] font-bold border-r border-[#808080] pb-2 sm:pb-0 pr-4">
                ...
                <div className="text-center sm:text-left text-[#000000] font-inter text-[14px] sm:text-[16px] font-bold pb-2 sm:pb-0">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 items-center justify-center mt-10 sm:flex sm:flex-wrap sm:flex-nowrap sm:gap-4 font-semibold hover:text-white">
            ...
            >
              ...
              <PiNotepadBold className="text-[#3F3BE1] opacity-[20%] h-[35px] sm:h-[6.80vw] w-[35px] sm:w-[5.76vw] group-hover:text-[#FFFFFF] mt-2" />
            </div>
            ...
            >
              ...
              <FaBriefcase className="text-[#3F3BE1] opacity-[20%] h-[30px] sm:h-[6.80vw] w-[30px] sm:w-[5.76vw] group-hover:text-[#FFFFFF] mt-2" />
            </div>
        ...
        <div className="relative flex flex-col lg:flex-row justify-between gap-[20px] mt-[32px] px-6 sm:mt-[100px] mx-auto ">
            ...
            <div className=" flex flex-col gap-2 p-6 border-[0.3px] border-[#000000] rounded-lg h-[250px] sm:w-[550px] sm:h-[266px]  relative">
              ...
              <div className="absolute bottom-1 right-1 text-4xl sm:text-3xl md:text-4xl lg:text-4xl text-gray-400">
                <svg
                  width="70"
                  height="70"
                  viewBox="0 0 50 50"
          ...
          <div className="mt-[10px] p-6">
            <div className="flex flex-col gap-2 p-6 border-[0.3px] h-[350px] border-[#000000] rounded-lg w-full sm:w-[550px] lg:w-[1130px]  sm:h-[250px] relative">
              ...
              <div className="absolute bottom-[10px] right-1 sm:bottom-1 sm:right-1 lg:bottom-1 lg:right-1 text-2xl sm:text-3xl lg:text-4xl text-gray-400">
                <svg
                  width="70"
                  height="70"
                  viewBox="0 0 50 50"
